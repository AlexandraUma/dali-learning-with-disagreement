...
Original file is located at
    https://colab.research.google.com/drive/1GXzb3jZ7Jd_Hn-NoRm6kZ2bumrKxoHEw
...
for experiment in range(num_experiments):
    ...
    for split_i in range(0, 5):
        ...
        experiment_hards.extend(pred_probs.tolist())
        experiment_softs.extend(aux_predprobs)
...
import json 
with open(writepath+ 'mre_hard_mtl_fornaciari_gold.jsonlines', 'w') as f:
    json.dump(hard_dictionary, f)

with open(writepath+ 'mre_soft_mtl_fornaciari_gold.jsonlines', 'w') as f:
