...
class ISModel(nn.Module):
    ...
    def forward(self, context_word_emb, head_word_emb, lm_emb, char_index, text_lens, gold_starts, gold_ends, features, one_hot_labels, soft_labels, items_multipliers, is_training):
        ...
        loss = -torch.sum(cross_entropy, 1) * items_multipliers
        return softmax_scores, None, loss.sum(), None
