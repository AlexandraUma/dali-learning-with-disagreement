...
class Trainer(object):
    ...
    def get_predictions(self, model, eval_documents, mtl=False):
        ...
        for tensorized_document in eval_documents:
            ...
            one_hot_pred, _, _, _ = model(context_word_emb, head_word_emb, lm_emb, char_index, text_len, gold_starts, gold_ends, features, one_hot_labels, external_weights, mv_distrs, is_training)
